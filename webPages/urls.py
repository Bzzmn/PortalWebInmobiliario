...
urlpatterns = [
    ...
    path('cancelar_solicitud/<int:solicitud_id>/', views.cancelarSolicitud, name='cancelarSolicitud'),
    path('eliminar_solicitud/<int:solicitud_id>/', views.eliminarSolicitud, name='eliminarSolicitud'),
    path('aceptar_solicitud/<int:solicitud_id>/', views.aceptarSolicitud, name='aceptarSolicitud'),
    path('rechazar_solicitud/<int:solicitud_id>/', views.rechazarSolicitud, name='rechazarSolicitud'),
    path('ocultar_inmueble/<int:inmueble_id>/', views.ocultarInmueble, name='ocultarInmueble'),
    path('eliminar_inmueble/<int:inmueble_id>/', views.eliminarInmueble, name='eliminarInmueble'),
    path('mostrar_inmueble/<int:inmueble_id>/', views.mostrarInmueble, name='mostrarInmueble'),
]
